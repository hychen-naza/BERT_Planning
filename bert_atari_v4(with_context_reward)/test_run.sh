...
for seed in 123
do
    python run_dt_atari.py --seed $seed --horizon 5 --context_length 25 --sample_iteration 10 --epochs 10 --model_type 'reward_conditioned' --num_steps 5000 --num_buffers 50 --game 'Breakout' --batch_size 64
done
